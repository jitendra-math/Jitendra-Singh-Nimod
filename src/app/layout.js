...
export const metadata = {
  ...
  alternates: {
    ...
    // If you have multiple language versions, add hreflang here
  },

  // Verification for Google Search Console (replace with your own code)
  // verification: {
  ...
  // Additional useful meta
  other: {
    "theme-color": "#2563EB", // your favourite blue
...
export default function RootLayout({ children }) {
  ...
  const personSchema = {
    ...
    alternateName: ["JS Nimod", "Jitu Nimod", "Jitendra Nimod", "Jitubanna", "Jitu Banna"],
    ...
    birthDate: "2009-05-14", // Optional – you can remove if privacy concern
  };
  ...
  const organizationSchema = {
    ...
    description: "Digital development brand by Jitendra Singh Nimod, creating modern web applications and digital identity platforms.",
    sameAs: [
      "https://github.com/jitendra-math",
      "https://www.instagram.com/jitendra.07_7",
    ],
  ...
  const websiteSchema = {
    ...
    description: "Official identity archive of Jitendra Singh Nimod, Full Stack Developer from Rajasthan.",
    publisher: {
      "@type": "Person",
      name: "Jitendra Singh Nimod",
    },
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* DNS prefetch for external platforms */}
      ...
      <body className="bg-gradient-to-br from-white via-zinc-50 to-white text-zinc-800 antialiased selection:bg-[#2563EB]/30 selection:text-white">
        {/* Premium background blobs – updated to light theme */}
