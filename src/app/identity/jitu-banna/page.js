// src/app/identity/jitu-banna/page.js
// Ultra-premium identity page for Jitu Banna – Primary Domain Alias
...
export const metadata = {
  title: "Jitu Banna – Primary Online Alias | Jitendra Singh Nimod",
  description:
    "Jitu Banna is the primary online alias and domain name (jitubanna.com) of Jitendra Singh Nimod, also known as JS Nimod and Jitu Nimod. Full Stack Developer from Rajasthan, India.",
  keywords: [
    "Jitu Banna",
    "Jitubanna",
  ...
  alternates: { canonical: "/identity/jitu-banna" },
  openGraph: {
    title: "Jitu Banna – Primary Online Alias",
    description:
      "Jitu Banna is the primary online alias and domain name of Jitendra Singh Nimod, a Full Stack Developer from Rajasthan.",
...
export default function JituBannaPage() {
  ...
  const jsonLd = {
    ...
    "@type": "Person",
    name: "Jitu Banna",
    alternateName: [identity.name, "Jitendra Nimod", "Jitu Nimod", "JS Nimod", "Jitubanna"],
    description: "Primary online alias and domain name of Jitendra Singh Nimod, a Full Stack Web Developer and B.Sc Mathematics student from Rajasthan, India.",
    url: "https://me.jitubanna.com/identity/jitu-banna",
    sameAs: [
      "https://jitubanna.com",
  ...
  const quickStats = [
    ...
    { label: "Domain", value: "jitubanna.com", icon: Globe2 },
      ...
      <main className="min-h-screen bg-gradient-to-br from-white via-zinc-50 to-white text-zinc-700 font-sans selection:bg-[#2563EB]/30 selection:text-white relative overflow-hidden pb-20">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#2563EB]/10 rounded-full text-[#2563EB] text-xs font-medium uppercase tracking-wider mb-6">
                ...
                <span>Primary Alias • Domain Name</span>
              </div>
              ...
              <p className="text-lg md:text-xl text-[#2563EB] font-medium mb-2">
                Primary online alias of {identity.name}
              </p>

              <p className="text-base text-zinc-600 max-w-2xl mx-auto md:mx-0 leading-relaxed mb-6">
                <strong className="text-[#2563EB]">Jitu Banna</strong> is the primary online alias and domain name 
                (<strong>jitubanna.com</strong>) of <strong>{identity.name}</strong>, a Full Stack Web Developer 
                from {identity.location.state}, India. Also known as <strong>JS Nimod, Jitu Nimod, and Jitubanna</strong>.
              </p>
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 mb-20">
          <div className="bg-gradient-to-br from-[#2563EB]/10 to-purple-500/10 rounded-3xl p-8 md:p-10 border border-[#2563EB]/20 text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-zinc-800 mb-3">The Domain: jitubanna.com</h2>
            <p className="text-zinc-600 max-w-2xl mx-auto mb-6">
              This alias is so significant that it owns the primary domain. 
              <strong className="text-[#2563EB]"> jitubanna.com</strong> serves as the flagship portfolio and central hub 
              for all projects under the Jitu Banna brand.
            </p>
            <a
              href="https://jitubanna.com"
              target="_blank"
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-zinc-200 rounded-3xl p-8 md:p-10 shadow-xl">
            ...
            <div className="prose prose-zinc max-w-none space-y-4">
              <p className="text-zinc-600 leading-relaxed">
                <strong className="text-[#2563EB]">Jitu Banna</strong> is the primary online alias and domain name 
                (<strong>jitubanna.com</strong>) of <strong>{identity.name}</strong>, a Full Stack Web Developer 
                from {identity.location.state}, {identity.location.country}. Also known as{' '}
                <strong>Jitendra Nimod, Jitu Nimod, and JS Nimod</strong>.
              </p>

              <p className="text-zinc-600 leading-relaxed">
                This alias represents the most recognizable online identity, combining the friendly nickname "Jitu" 
                with the respectful suffix "Banna" – deeply rooted in Rajasthan's cultural heritage. It's the name 
                used across developer communities, social platforms, and as the primary domain.
              </p>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mt-6">
                <p className="text-amber-800 text-sm flex items-start gap-2">
                  ...
                  <span>
                    Searches such as <strong>“Jitu Banna developer”</strong>, <strong>“Jitu Banna Rajasthan”</strong>, and{' '}
                    <strong>“jitubanna.com”</strong> all refer to the same individual —{' '}
              ...
              <p className="text-zinc-600 leading-relaxed font-medium border-l-4 border-[#2563EB] pl-4">
                This official website confirms that Jitu Banna is the primary alias of {identity.name}, and the domain 
                <strong className="text-[#2563EB]"> jitubanna.com</strong> is the flagship website.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 mb-16">
          <div className="bg-gradient-to-br from-[#2563EB] to-purple-600 rounded-3xl p-8 md:p-12 text-white text-center shadow-2xl">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Connect with Jitu Banna</h2>
        ...
        <div className="relative z-10 text-center text-xs text-zinc-400 mt-16">
          <Heart className="w-3 h-3 inline text-rose-400" /> Jitu Banna = {identity.name} | jitubanna.com
        </div>
      </main>
    </>
  );
