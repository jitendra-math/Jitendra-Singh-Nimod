// src/app/identity/jitu-nimod/page.js
// Ultra-premium identity page for Jitu Nimod alias
...
export const metadata = {
  title: "Jitu Nimod – Official Identity | Jitendra Singh Nimod",
  description:
  ...
  keywords: [
    "Jitu Nimod",
    "Jitu Nimod developer",
    "Jitu Nimod Rajasthan",
    "Jitu Nimod student",
    "Jitendra Singh Nimod",
    "JS Nimod",
    "Jitendra Nimod"
  ],
  alternates: { canonical: "/identity/jitu-nimod" },
  openGraph: {
    title: "Jitu Nimod – Official Identity",
    description:
      "Jitu Nimod is another name for Jitendra Singh Nimod, a Full Stack Developer from Rajasthan.",
    images: [{ url: "/images/og/jitu-nimod-og.jpg", width: 1200, height: 630 }],
  },
};
...
export default function JituNimodPage() {
  ...
  const jsonLd = {
    ...
    "@type": "Person",
    name: "Jitu Nimod",
    alternateName: [identity.name, "Jitendra Nimod", "JS Nimod"],
    description: "Full Stack Web Developer and B.Sc Mathematics student from Rajasthan, India. Nickname of Jitendra Singh Nimod.",
    url: "https://me.jitubanna.com/identity/jitu-nimod",
    sameAs: identity.sameAs
  };

  const quickStats = [
    { label: "Nickname", value: "Jitu Nimod", icon: Smile },
      ...
      <main className="min-h-screen bg-gradient-to-br from-white via-zinc-50 to-white text-zinc-700 font-sans selection:bg-[#2563EB]/30 selection:text-white relative overflow-hidden pb-20">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#2563EB]/10 rounded-full text-[#2563EB] text-xs font-medium uppercase tracking-wider mb-6">
                ...
                <span>Nickname / Friendly Alias</span>
              </div>
              ...
              <p className="text-lg md:text-xl text-[#2563EB] font-medium mb-2">
                Nickname for {identity.name}
              </p>

              <p className="text-base text-zinc-600 max-w-2xl mx-auto md:mx-0 leading-relaxed mb-6">
                <strong className="text-[#2563EB]">Jitu Nimod</strong> is another name used for{' '}
                <strong>{identity.name}</strong>, a Full Stack Web Developer and B.Sc Mathematics student from{' '}
                {identity.location.state}, India. Also known as <strong>JS Nimod and Jitendra Nimod</strong>.
              </p>
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 mb-20">
          <div className="bg-white/80 backdrop-blur-sm border border-zinc-200 rounded-3xl p-8 md:p-10 shadow-xl">
            ...
            <div className="prose prose-zinc max-w-none space-y-4">
              ...
              <p className="text-zinc-600 leading-relaxed">
                Many people search online for <strong>Jitu Nimod</strong>. This name refers to{' '}
                <strong>{identity.name}</strong>, who is also known as{' '}
                <strong>{identity.alternateNames.join(", ")}</strong>.
              </p>

              <p className="text-zinc-600 leading-relaxed">
                {identity.shortName} is currently studying {identity.education.degree} at {identity.education.college} and is
                actively building modern web projects and digital platforms.
              </p>

              <p className="text-zinc-600 leading-relaxed">
                He is based in {identity.location.city}, Rajasthan and belongs to {identity.location.village} village. 
                Under the brand <strong>{identity.brand}</strong>, he builds web tools and scalable online platforms.
              </p>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mt-6">
                <p className="text-amber-800 text-sm flex items-start gap-2">
                  ...
                  <span>
                    Searches like <strong>“Jitu Nimod developer”</strong>, <strong>“Jitu Nimod Rajasthan”</strong> and{' '}
                    <strong>“Jitu Nimod student”</strong> all refer to the same individual —{' '}
              ...
              <p className="text-zinc-600 leading-relaxed font-medium border-l-4 border-[#2563EB] pl-4">
                This official website confirms that Jitu Nimod and {identity.name} are the same person.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 mb-16">
          <div className="bg-gradient-to-br from-[#2563EB] to-purple-600 rounded-3xl p-8 md:p-12 text-white text-center shadow-2xl">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Connect with Jitu Nimod</h2>
        ...
        <div className="relative z-10 text-center text-xs text-zinc-400 mt-16">
          <Heart className="w-3 h-3 inline text-rose-400" /> Jitu Nimod = {identity.name}
        </div>
      </main>
    </>
  );
