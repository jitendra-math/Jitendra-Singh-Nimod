// src/app/identity/nimod-js/page.js
// Ultra-premium identity page for Nimod JS alias
...
export const metadata = {
  title: "Nimod JS – Identity Clarification | Jitendra Singh Nimod",
  description:
    "Nimod JS refers to Jitendra Singh Nimod, also known as Jitendra Nimod, Jitu Nimod and JS Nimod. Full Stack Developer from Rajasthan, India.",
  keywords: [
    "Nimod JS",
    "Nimod JS developer",
    "Nimod JS Rajasthan",
  ...
  alternates: { canonical: "/identity/nimod-js" },
  openGraph: {
    title: "Nimod JS – Identity Clarification",
    description:
      "Nimod JS is a search term referring to Jitendra Singh Nimod, a Full Stack Developer from Rajasthan.",
    images: [{ url: "/images/og/nimod-js-og.jpg", width: 1200, height: 630 }],
  },
};

export default function NimodJSPage() {
  ...
  const jsonLd = {
    ...
    url: "https://me.jitubanna.com/identity/nimod-js",
    sameAs: identity.sameAs
  };

  const quickStats = [
    { label: "Alias", value: "Nimod JS", icon: AtSign },
    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-white via-zinc-50 to-white text-zinc-700 font-sans selection:bg-[#2563EB]/30 selection:text-white relative overflow-hidden pb-20">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-base text-zinc-600 max-w-2xl mx-auto md:mx-0 leading-relaxed mb-6">
                <strong className="text-[#2563EB]">Nimod JS</strong> is a name associated with{' '}
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 mb-20">
          <div className="bg-white/80 backdrop-blur-sm border border-zinc-200 rounded-3xl p-8 md:p-10 shadow-xl">
            ...
            <div className="prose prose-zinc max-w-none space-y-4">
              ...
              <p className="text-zinc-600 leading-relaxed">
                This variation appears in search engines when users look for the developer from Nimod village with initials JS. 
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mt-6">
                <p className="text-amber-800 text-sm flex items-start gap-2">
                  ...
                  <span>
                    <strong>Nimod JS</strong> is a search term used for Jitendra Singh Nimod, a Full Stack Web Developer 
        ...
        <div className="relative z-10 text-center text-xs text-zinc-400 mt-16">
          <Heart className="w-3 h-3 inline text-rose-400" /> Nimod JS = {identity.name}
        </div>
      </main>
    </>
  );
