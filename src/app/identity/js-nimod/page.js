// src/app/identity/js-nimod/page.js
// Ultra-premium identity page for JS Nimod alias
...
export const metadata = {
  title: "JS Nimod – Official Profile | Jitendra Singh Nimod",
  description:
  ...
  alternates: { canonical: "/identity/js-nimod" },
  openGraph: {
    title: "JS Nimod – Official Profile",
    description:
      "JS Nimod is the online identity of Jitendra Singh Nimod, a Full Stack Developer from Rajasthan.",
    images: [{ url: "/images/og/js-nimod-og.jpg", width: 1200, height: 630 }],
  },
};
...
export default function JSNimodPage() {
  ...
  const jsonLd = {
    ...
    "@type": "Person",
    name: "JS Nimod",
    alternateName: [identity.name, "Jitendra Nimod", "Jitu Nimod"],
    description: "Full Stack Web Developer and B.Sc Mathematics student from Rajasthan, India. Online identity of Jitendra Singh Nimod.",
    url: "https://me.jitubanna.com/identity/js-nimod",
    sameAs: identity.sameAs
  };

  const quickStats = [
    { label: "Online Identity", value: "JS Nimod", icon: AtSign },
      ...
      <main className="min-h-screen bg-gradient-to-br from-white via-zinc-50 to-white text-zinc-700 font-sans selection:bg-[#2563EB]/30 selection:text-white relative overflow-hidden pb-20">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#2563EB]/10 rounded-full text-[#2563EB] text-xs font-medium uppercase tracking-wider mb-6">
                ...
                <span>Online Identity / Alias</span>
              </div>
              ...
              <p className="text-base text-zinc-600 max-w-2xl mx-auto md:mx-0 leading-relaxed mb-6">
                <strong className="text-[#2563EB]">JS Nimod</strong> is a short name and online identity of{' '}
                <strong>{identity.name}</strong>, a Full Stack Web Developer from {identity.location.state}, India. 
                Also known as <strong>Jitendra Nimod and Jitu Nimod</strong>.
              </p>
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-zinc-200 rounded-3xl p-8 md:p-10 shadow-xl">
            ...
            <div className="prose prose-zinc max-w-none space-y-4">
              <p className="text-zinc-600 leading-relaxed">
                <strong className="text-[#2563EB]">JS Nimod</strong> is a short name and online identity of{' '}
                <strong>{identity.name}</strong>, a Full Stack Web Developer from {identity.location.state}, {identity.location.country}.
              </p>

              <p className="text-zinc-600 leading-relaxed">
                Many people search for <strong>JS Nimod</strong> on Google and social platforms. This
                name refers to {identity.name}, who is also known as{' '}
                <strong>{identity.alternateNames.join(", ")}</strong>.
              </p>

              <p className="text-zinc-600 leading-relaxed">
                As a developer and student, {identity.shortName} is currently pursuing {identity.education.degree} at{' '}
                {identity.education.college}. He builds modern web applications, developer tools and SEO-optimized platforms.
              </p>

              <p className="text-zinc-600 leading-relaxed">
                Based in {identity.location.city}, Rajasthan, India, JS Nimod is actively working on digital projects and web technologies under
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mt-6">
                <p className="text-amber-800 text-sm flex items-start gap-2">
                  ...
                  <span>
                    Searches such as <strong>“JS Nimod developer”</strong>, <strong>“JS Nimod India”</strong> and{' '}
                    <strong>“JS Nimod Rajasthan”</strong> all refer to the same person —{' '}
              ...
              <p className="text-zinc-600 leading-relaxed font-medium border-l-4 border-[#2563EB] pl-4">
                This official website confirms that JS Nimod is the same individual as {identity.name}, also known as Jitendra Nimod and Jitu Nimod.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 mb-16">
          <div className="bg-gradient-to-br from-[#2563EB] to-purple-600 rounded-3xl p-8 md:p-12 text-white text-center shadow-2xl">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Connect with JS Nimod</h2>
        ...
        <div className="relative z-10 text-center text-xs text-zinc-400 mt-16">
          <Heart className="w-3 h-3 inline text-rose-400" /> JS Nimod = {identity.name}
        </div>
      </main>
    </>
  );
