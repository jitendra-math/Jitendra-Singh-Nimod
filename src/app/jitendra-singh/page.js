...
// Premium Teal & Gold theme – Warm Ivory background, Soft Yellow highlights
...
export default function JitendraSinghPage() {
  ...
  return (
    <main className="relative min-h-screen bg-[#FCF9F2] overflow-x-hidden">
      ...
      {/* HERO SECTION – with Soft Yellow background accent */}
      ...
      <article className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 space-y-16 pb-24">
        ...
        {/* PROFILE & ARCHITECTURE (cards with soft yellow accents) */}
        <section className="text-center">
        ...
        <section className="text-center">
          ...
          {/* Hover stat – gold accent */}
          <div className="relative pt-4 border-t border-[#F3E8BC] max-w-md mx-auto">
            <div className="flex items-center justify-center gap-3 text-xs text-[#6B6B6B] group/stats cursor-pointer">
              <Sparkles className="w-3.5 h-3.5 text-[#C9A84C]" />
              <span className="group-hover/stats:text-[#035352] transition-colors">
              ...
              <div className="relative overflow-hidden h-5 group-hover/stats:max-w-[200px] max-w-0 transition-all duration-300">
                <span className="whitespace-nowrap text-[#035352] font-mono text-xs">
        ...
        {/* IDENTITY BRANCHING – plain links, gold hover */}
        <section className="text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
